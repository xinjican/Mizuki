...
export const siteConfig: SiteConfig = {
	title: "aimer",
	subtitle: "sy",
	siteURL: "https://xinjican.github.io/Mizuki/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "517863918", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/517863918",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/xinjican",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/xinjican",
		},
		{
			name: "Codeberg",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to my blog!", // 公告内容 "ブログへようこそ！これはサンプルの告知です"
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	id: "17903256745", // 歌单ID "14164869977"
...
export const footerConfig: FooterConfig = {
	...
	customHtml:
		'<a href="https://icp.gov.moe/?keyword=20260631" target="_blank">萌ICP备20260631号</a>', // HTML格式的自定义页脚信息，例如备案号等，默认留空
